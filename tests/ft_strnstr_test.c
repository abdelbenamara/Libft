...
/*   Updated: 2022/12/21 15:13:42 by abenamar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_strnstr_test(void)
{
	...
	printf("ft_strnstr\t");
	assert(ft_strnstr(str, "", 0 * sizeof(char)) == strnstr(str, "", 0 * sizeof(char)));
	...
	assert(ft_strnstr(str, "is", 5 * sizeof(char)) == strnstr(str, "is", 5 * sizeof(char)));
